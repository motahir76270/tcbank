...
const ForgetPassword = () => {
  ...
  const handleSubmit = async(e) => {
    try{
      ...
      const {data} = await axios.put('http://3.110.164.139:8080/account/login-password-change',payload , {
         headers: {
      ...
      console.log(errors)
      alert('some thing went wroung')
    }
  };

  return (
    <section className="bg-gray-200 flex flex-col justify-center py-9 sm:px-6 lg:px-8">
